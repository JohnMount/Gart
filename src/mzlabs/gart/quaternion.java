...
// $Header: /Users/johnmount/Documents/CVSRoot/mzlabs/src/mzlabs/gart/quaternion.java,v 1.4 2007/07/15 15:01:47 johnmount Exp $
...
public final class quaternion {
	...
	public void qmult(quaternion a, quaternion b) {
		set(a.e * b.e - a.i * b.i - a.j * b.j - a.k * b.k, a.e * b.i + a.i
				* b.e + a.j * b.k - a.k * b.j, a.e * b.j - a.i * b.k + a.j
				* b.e + a.k * b.i, a.e * b.k + a.i * b.j - a.j * b.i + a.k
				* b.e);
	}
	...
	public void qstd(final double x, final double y, final double z) {
		e = 0.0;
		i = x;
		j = y;
		k = z;
	...
	public void qcx(final double x, final double y, final double z) {
		e = x;
		i = 0.0;
		j = 0.0;
		k = 0.0;
	...
	public void qcy(final double x, final double y, final double z) {
		e = y;
		i = 0.0;
		j = 0.0;
		k = 0.0;
	...
	public void qcx1(final double x, final double y, final double z) {
		e = x;
		i = 0.0;
		j = 0.0;
		k = 1.0 + z;
	...
	public void qcy1(final double x, final double y, final double z) {
		e = y;
		i = 0.0;
		j = 0.0;
		k = 1.0 + z;
	...
	public void qcx2(final double x, final double y, final double z) {
		e = x;
		i = 1.0 + z;
		j = 0.0;
		k = 0.0;
	...
	public void qcy2(final double x, final double y, final double z) {
		e = y;
		i = 0.0;
		j = 1.0 + z;
		k = 0.0;
	...
	public void qcxy(final double x, final double y, final double z) {
		e = x;
		i = y;
		j = z;
		k = z;
	...
	public void qcxy2(final double x, final double y, final double z) {
		e = x;
		i = y;
		j = x + z;
		k = y + z;
